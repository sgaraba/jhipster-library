...
public class BorrowedBookResource {
    ...
    public ResponseEntity<List<BorrowedBook>> getAllBorrowedBooks(BorrowedBookCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
