...
public class BookResource {
     ...
     */
    @GetMapping("/books")
    public ResponseEntity<List<Book>> getAllBooks(BookCriteria criteria, Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
